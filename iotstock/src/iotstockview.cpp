...
//NOTE: Common configuration fields need to be shared between iotpos and iotstock (low stock alarm value).
...
iotstockView::iotstockView(QWidget *parent)
    : QWidget(parent)
{
  qDebug()<<"===STARTING IOTSTOCK AT "<<QDateTime::currentDateTime().toString()<<" ===";
  adminIsLogged = false;
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("view-statistics", 22)));
  ...
  itmEndOfDay     = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("End of Day"), ui_mainview.reportsList);
  itmGralEndOfDay = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("General End of Day"), ui_mainview.reportsList);
  itmEndOfMonth   = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("End of Month"), ui_mainview.reportsList);
  itmPrintSoldOutProducts = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("Sold Out Products"), ui_mainview.reportsList);
  itmPrintLowStockProducts = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("Low Stock Products"), ui_mainview.reportsList);
  itmPrintStock   = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("Stock Report"), ui_mainview.reportsList);
  //itmPrintBalance = new QListWidgetItem(themedPixmap("iotpos-reports", 96), i18n("A Balance"), ui_mainview.reportsList);

  
  ui_mainview.btnBalances->setIcon(themedPixmap("iotposbalance", 22));
  ui_mainview.btnCashFlow->setIcon(themedPixmap("iotpos-cashout", 22));
  ui_mainview.btnTransactions->setIcon(themedPixmap("wallet-open", 22));
  ui_mainview.btnSO->setIcon(themedPixmap("iotpos-box", 22));
  ...
  notifierPanel = new MibitNotifier(this,logoBottomFile, themedPixmap("dialog-warning", 22));

}

void iotstockView::checkDefaultView()
{
...
void iotstockView::cleanErrorLabel()
{
  ui_mainview.errLabel->clear();
  ui_mainview.errLabel->hide();
}

void iotstockView::login(){
  qDebug()<<"Login()";
  adminIsLogged = false;
  loggedUserId = 0;
  disableUI();
...
void iotstockView::setupSignalConnections()
{
  ...
  //      kde systemsettings preference dialog (mose and keyboard config) is fine for iotstock, but not for iotpos using a touchscreen. In this
  //      last case, it make sense to let "single click activates" setting on kde systemsettings since is rarely used iotpos and iotstock in the same pc.
...
void iotstockView::doEmitSignalSalir()
{
  emit signalSalir();
}

void iotstockView::enableUI()
{
  ui_mainview.stackedWidget->show();
}

void iotstockView::disableUI()
{
  ui_mainview.stackedWidget->hide();
}

void iotstockView::showWelcomeGraphs()
{
...
void iotstockView::showPrefs()
{
  emit signalShowPrefs();
}

void iotstockView::showProductsPage()
{
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-box",22)));
  ui_mainview.btnPrintBalance->hide();
...
void iotstockView::showOffersPage()
{
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-offers",22)));
...
void iotstockView::showUsersPage()
{
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-user",22)));
  ui_mainview.btnPrintBalance->hide();
}

void iotstockView::showMeasuresPage()
{
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-ruler",22)));
  ui_mainview.btnPrintBalance->hide();
}

void iotstockView::showDepartmentsPage()
{
    ...
    ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-categories",22)));
    ui_mainview.btnPrintBalance->hide();
}

void iotstockView::showCategoriesPage()
{
...
void iotstockView::showSubCategoriesPage()
{
...
void iotstockView::showClientsPage()
{
...
void iotstockView::showTransactionsPage()
{
...
void iotstockView::showBalancesPage()
{
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-balance",22)));
  ui_mainview.btnPrintBalance->show();
  QTimer::singleShot(200,fpFilterBalances, SLOT(fixPos()));
}

void iotstockView::showSpecialOrders()
{
  ui_mainview.stackedWidget->setCurrentIndex(pReports);
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-box",22))); //FIXME: Create an icon
  QTimer::singleShot(200,fpFilterSpecialOrders, SLOT(fixPos()));
  ui_mainview.datePicker->setDate(QDate::currentDate());
}


void iotstockView::showCashFlowPage()
{
  ui_mainview.stackedWidget->setCurrentIndex(pReports);
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("iotpos-cashout",22)));
  ui_mainview.cashFlowTable->resizeColumnsToContents();
  ui_mainview.btnPrintBalance->hide();
}

void iotstockView::showReports()
{
  ui_mainview.stackedWidget->setCurrentIndex(pReports);
...
void iotstockView::toggleFilterBox(bool show)
{
  if (show) {
...
void iotstockView::adjustProductsTable()
{
...
void iotstockView::adjustOffersTable()
{
...
void iotstockView::showProdListAsGrid()
{
...
void iotstockView::showProdListAsTable()
{
...
iotstockView::~iotstockView()
{
}

void iotstockView::setupGraphs()
{
  //plots...
...
void iotstockView::updateGraphs()
{
  if (!db.isOpen()) openDB();
  if (db.isOpen()) {
    if (!graphSoldItemsCreated ) setupGraphs();
...
void iotstockView::checkDBStatus()
{
 if (!isConnected()) {
  if (counter < 4) {
    counter++;
...
void iotstockView::closeDB()
{
  db.close();
}

void iotstockView::setupUsersModel()
{
  if (db.isOpen()) {
    ...
    QString details = db.lastError().text();
    KMessageBox::detailedError(this, i18n("Iotstock has encountered an error, click details to see the error details."), details, i18n("Error"));
    QTimer::singleShot(10000, this, SLOT(setupUsersModel()));
  }
}

void iotstockView::setupProductsModel()
{
  openDB();
...
void iotstockView::populateDepartmentsHash()
{
...
void iotstockView::populateCategoriesHash()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
  categoriesHash.clear();
...
void iotstockView::populateCardTypesHash()
{
    Azahar *myDb = new Azahar;
    myDb->setDatabase(db);
    cardTypesHash.clear();
...
void iotstockView::populateSubCategoriesHash()
{
    Azahar *myDb = new Azahar;
    myDb->setDatabase(db);
    subcategoriesHash.clear();
...
void iotstockView::setProductsFilter()
{
...
void iotstockView::setupOffersModel()
{
...
void iotstockView::setupMeasuresModel()
{
  if (db.isOpen()) {
...
void iotstockView::setupCategoriesModel()
{
  if (db.isOpen()) {
...
void iotstockView::setupDepartmentsModel()
{
    if (db.isOpen()) {
...
void iotstockView::setupSubCategoriesModel()
{
    if (db.isOpen()) {
...
void iotstockView::setupClientsModel()
{
  if (db.isOpen()) {
...
void iotstockView::setupTransactionsModel()
{
  openDB();
...
void iotstockView::setTransactionsFilter()
{
  //NOTE: This is a QT BUG.
  //   If filter by description is selected and the text is empty, and later is re-filtered
  //   then NO pictures are shown; even if is refiltered again.
...
//CURRENCIES
void iotstockView::setupCurrenciesModel()
{
    if (db.isOpen()) {
...
void iotstockView::setupBalancesModel()
{
  openDB();
...
void iotstockView::setBalancesFilter()
{
  //NOTE: This is a QT BUG.
  //   If filter by description is selected and the text is empty, and later is re-filtered
  //   then NO pictures are shown; even if is refiltered again.
...
void iotstockView::setupSpecialOrdersModel()
{
  openDB();
...
void iotstockView::setSpecialOrdersFilter()
{
...
//reservationsModel
void iotstockView::setupReservationsModel()
{
    if (db.isOpen()) {
...
void iotstockView::reservationsOnSelected(const QModelIndex &index)
{
    if (db.isOpen()) {
...
void iotstockView::settingsChanged()
{
...
void iotstockView::settingsChangedOnInitConfig()
{
...
void iotstockView::setOffersFilter()
{
...
void iotstockView::usersViewOnSelected(const QModelIndex & index)
{
 if (db.isOpen()) {
    //getting data from model...
    const QAbstractItemModel *model = index.model();
...
void iotstockView::productsViewOnSelected(const QModelIndex &index)
{
 if (db.isOpen()) {
  //getting data from model...
    const QAbstractItemModel *model = index.model();
...
void iotstockView::clientsViewOnSelected(const QModelIndex & index)
{
  if (db.isOpen()) {
    //getting data from model...
    const QAbstractItemModel *model = index.model();
...
void iotstockView::stockCorrection()
{
...
void iotstockView::correctStock(qulonglong code, double oldStock, double newStock, const QString &reason)
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::createProduct()
{
 if (db.isOpen()) {
...
TransactionInfo iotstockView::createPurchase(ProductInfo info)
{
    TransactionInfo tInfo;
    if (db.isOpen()) {
        Azahar *myDb = new Azahar;
...
void iotstockView::createMeasure()
{
 if (db.isOpen()) {
...
void iotstockView::createDepartment()
{
    //Launch Edit dialog
...
void iotstockView::createCategory()
{
    //Launch Edit dialog
    SubcategoryEditor *scEditor = new SubcategoryEditor(this);
    //get categories list and populate the dialog with them.
...
void iotstockView::updateDepartmentsCombo()
{
  populateDepartmentsHash();
  ui_mainview.comboProductsFilterByDepartment->clear();
...
void iotstockView::updateCategoriesCombo()
{
  populateCategoriesHash();
  ui_mainview.comboProductsFilterByCategory->clear();
  QHashIterator<QString, int> item(categoriesHash);
...
void iotstockView::updateCardTypesCombo()
{
...
void iotstockView::updateSubCategoriesCombo()
{
    populateSubCategoriesHash();
    ui_mainview.comboProductsFilterBySubCategory->clear();
...
void iotstockView::createSubCategory()
{
    bool ok=false;
...
void iotstockView::createClient()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::deleteSelectedClient()
{
  if (db.isOpen()) {
...
void iotstockView::deleteSelectedUser()
{
  if (db.isOpen()) {
...
void iotstockView::deleteSelectedOffer()
{
  if (db.isOpen()) {
...
void iotstockView::deleteSelectedProduct()
{
  if (db.isOpen()) {
    Azahar *myDb = new Azahar;
    myDb->setDatabase(db);
...
void iotstockView::deleteSelectedMeasure()
{
  if (db.isOpen()) {
...
void iotstockView::deleteSelectedDepartment()
{
    if (db.isOpen()) {
...
void iotstockView::deleteSelectedCategory()
{
  if (db.isOpen()) {
...
void iotstockView::deleteSelectedSubCategory()
{
    if (db.isOpen()) {
...
//CASH OUTS
void iotstockView::setupCashFlowModel()
{
  openDB();
...
void iotstockView::exportQTableView(QAbstractItemView *tableview)
{
  if (tableview->model()){
...
void iotstockView::reportActivated(QListWidgetItem *item)
{
...
void iotstockView::printGralEndOfDay()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::printEndOfDay()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::printEndOfMonth()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::printLowStockProducts()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::printSoldOutProducts()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
void iotstockView::printSelectedBalance()
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
...
//LOGS
void iotstockView::log(const qulonglong &uid, const QDate &date, const QTime &time, const QString &text)
{
  Azahar *myDb = new Azahar;
  myDb->setDatabase(db);
  myDb->insertLog(uid, date, time, "[IOTSTOCK] "+text);
  logsModel->select();
  delete myDb;
}

void iotstockView::showLogs()
{
  ...
  ui_mainview.headerImg->setPixmap((themedPixmap("view-pim-tasks-pending",22)));
}
...
//Random Messages
void iotstockView::setupRandomMsgModel()
{
  openDB();
...
void iotstockView::createRandomMsg()
{
 if (db.isOpen()) {
...
void iotstockView::createCurrency()
{
    if (db.isOpen()) {
...
void iotstockView::deleteSelectedCurrency()
{
    if (db.isOpen()) {
...
void iotstockView::reSelectModels()
{
...
void iotstockView::categoriesOnSelected(const QModelIndex &index)
{
    if (db.isOpen()) {
        //getting data from model...
        const QAbstractItemModel *model = index.model();
