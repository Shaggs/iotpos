    ...
    : QWidget(parent)
{
  ...
  itmEndOfDay     = new QListWidgetItem(DesktopIcon("iotpos-reports", 96), i18n("End of Day"), ui_mainview.reportsList);
  itmGralEndOfDay = new QListWidgetItem(DesktopIcon("iotpos-reports", 96), i18n("General End of Day"), ui_mainview.reportsList);
  itmEndOfMonth   = new QListWidgetItem(DesktopIcon("iotpos-reports", 96), i18n("End of Month"), ui_mainview.reportsList);
  itmPrintSoldOutProducts = new QListWidgetItem(DesktopIcon("iotpos-reports", 96), i18n("Sold Out Products"), ui_mainview.reportsList);
  itmPrintLowStockProducts = new QListWidgetItem(DesktopIcon("iotpos-reports", 96), i18n("Low Stock Products"), ui_mainview.reportsList);
  itmPrintStock   = new QListWidgetItem(DesktopIcon("iotpos-reports", 96), i18n("Stock Report"), ui_mainview.reportsList);
